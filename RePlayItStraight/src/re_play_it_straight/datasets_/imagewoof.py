...
def Imagewoof(args):
    ...
    if not os.path.exists(dataset_dir):
        try:
            ...
            print(f"[!] Kaggle download for Imagewoof failed ({e}). Falling back to Fast.ai servers...")
            import requests
            import tarfile
            ...
            tgz_path = os.path.join(args.data_path, "imagewoof2-320.tgz")
            
            print("Downloading Imagewoof from Fast.ai...")
            ...
            extracted_path = os.path.join(args.data_path, "imagewoof2-320")
